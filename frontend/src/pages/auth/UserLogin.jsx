    ...
    return (
        <div className='min-h-screen w-full flex items-center justify-center p-4 py-10 overflow-y-auto' style={{ backgroundColor: bgColor }}>
            <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 `} style={{
                ...
                <div className='text-right mb-4 etxt-[#ff4d2d] font-medium' onClick={()=>navigate("/forgot-password")}>
                    Forgot Password
                </div>
...
<span>Sign In with Google</span>
            ...
            <p className='text-center mt-6 cursor-pointer' onClick={()=>navigate("/user/register")}>Want to create a new account ?  <span className='text-[#ff4d2d]'>Sign In</span></p>
            </div>
        </div>
    )
}
